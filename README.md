...
- **設定の表現：** 曜日別営業時間と日別上書きの持ち方、休業日の締切計算用時刻の初期化、毎時以外の開店時刻を許すか、同一対象・同一適用日の変更競合、過去・当日を適用日とする変更や適用予定の取消の扱いを定める。適用時刻と30日の境界は上記の確定仕様に従う。
...
- [ ] Task 1.1.2：適用日00:00・31日後以降の事前変更・30日後までの直近変更を仕様化し、設定履歴・競合・予定取消の扱いと影響確認・通知手順を設計する。
